...
int containsAssembleWords()
{
    ...
    {
        printf("Function assemble failed.  Assemble should call printLabels.\n");
        return 0;
    }
    ...
    {
        printf("Function assemble failed.  Part 1 function assemble should NOT have call to secondPass.\n");
        return 0;
    }		
    return 1;
}
